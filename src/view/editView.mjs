export const editView = {
  init: function (obj, handleSubmitEditView) {
    ...
    this.attachEventHandlers(handleSubmitEditView);
  },
  ...
  attachEventHandlers: function (handleSubmitEditView) {
    ...
    const myFunction = (e) => {
      ...
      if (e.target.getAttribute("type") === "submit") {
        ...
        return handleSubmitEditView(obj);
      }
